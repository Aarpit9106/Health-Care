        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <p className="text-xl text-gray-300 leading-relaxed max-w-2xl">
                ...
                platform. Advanced analytics, automated workflows, and enterprise-grade 
                security designed for healthcare professionals and institutions.
              </p>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-8 pt-8 border-t border-gray-700">
              ...
              <div className="flex items-center gap-2">
                <div className="flex items-center">
                  ...
                  <span className="text-sm text-gray-300 ml-1">4.9★ Rating</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative">
              ...
              <div className="relative w-80 h-64 bg-gradient-to-br from-gray-600 to-gray-800 rounded-2xl shadow-2xl overflow-hidden border border-gray-600">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <svg 
                    ...
                    fill="currentColor"
                  >
                    <path d="M50 75c0-30 20-50 50-50s50 20 50 50c0 15-5 25-15 35-5 5-10 8-15 10h-40c-5-2-10-5-15-10-10-10-15-20-15-35z" opacity="0.8"/>
                    <path d="M60 70c0-20 15-35 35-35s35 15 35 35c0 10-5 20-10 25-3 3-7 5-10 7h-30c-3-2-7-4-10-7-5-5-10-15-10-25z" opacity="0.6"/>
                    <path d="M75 75c0-15 10-25 25-25s25 10 25 25c0 8-3 15-8 20-2 2-5 3-7 4h-20c-2-1-5-2-7-4-5-5-8-12-8-20z" opacity="0.4"/>
                    {/* Brain details */}
                    <circle cx="85" cy="65" r="3" opacity="0.7"/>
                    <circle cx="115" cy="65" r="3" opacity="0.7"/>
                    <path d="M70 80 Q100 85 130 80" stroke="currentColor" strokeWidth="2" fill="none" opacity="0.5"/>
                    <path d="M75 90 Q100 95 125 90" stroke="currentColor" strokeWidth="2" fill="none" opacity="0.5"/>
                  </svg>
                </div>
              ...
              <div className="absolute -bottom-6 -right-6 w-12 h-12 bg-cyan-400/20 rounded-full blur-xl animate-pulse" style={{animationDelay: '1s'}} />
            </div>
          </div>
        </div>
      </div>
