      ...
      findings: [
        {
          ...
          severity: "low",
          description:
            "No signs of pneumonia, pleural effusion, or pneumothorax detected.",
        },
        {
          ...
          severity: "low",
          description:
            "Slight increase in cardiac silhouette, possibly within normal limits.",
        },
      ],
      recommendations: [
      ...
      findings: [
        {
          ...
          severity: "low",
          description:
            "Appears to be a common mole with regular borders and uniform coloration.",
        },
        {
          ...
          severity: "low",
          description:
            "Alternative diagnosis showing benign skin growth characteristics.",
        },
      ],
      recommendations: [
          ...
          findings: [
            {
              ...
              severity: "low",
              description:
                "AI analysis suggests normal appearance with no immediate concerns detected.",
            },
          ],
          recommendations: [
        ...
        <div className="p-8">
          ...
          <Alert className="mb-8 border-yellow-200 bg-yellow-50">
            ...
            <AlertDescription className="text-yellow-800">
              <strong>Important:</strong> This AI analysis is for educational
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Supports X-rays, CT scans, MRI, skin photos, and more
                    </p>
                  </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-700">
                        AI is processing your medical image. This may take a few
                        moments.
                      </p>
                    </div>
                  </div>
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600">
                              {result.analysisType} • {result.uploadDate}
                            </p>
                          </div>
                        </div>
