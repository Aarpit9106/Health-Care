...
export default function MoodMonitor() {
  ...
  const moodDistribution = Object.entries(MOOD_LABELS).map(
    ([value, label]) => ({
      name: label,
      value: moodEntries.filter((entry) => entry.mood === parseInt(value))
        .length,
  ...
  const averageMood =
    ...
    moodEntries.length;
  const averageEnergy =
    moodEntries.reduce((sum, entry) => sum + entry.energy, 0) /
    moodEntries.length;
  const averageStress =
    moodEntries.reduce((sum, entry) => sum + entry.stress, 0) /
    moodEntries.length;
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-gray-600 mt-2">
                Track your mental health and emotional wellbeing
              </p>
            </div>
              ...
              <DialogContent className="sm:max-w-[425px]">
                ...
                <div className="grid gap-4 py-4">
                  <div className="grid gap-2">
                    ...
                    <Select
                      onValueChange={(value) =>
                        setNewEntry({ ...newEntry, mood: parseInt(value) })
                      }
                    >
                      <SelectTrigger>
                  ...
                  <div className="grid gap-2">
                    ...
                    <Select
                      onValueChange={(value) =>
                        setNewEntry({ ...newEntry, energy: parseInt(value) })
                      }
                    >
                      <SelectTrigger>
                  ...
                  <div className="grid gap-2">
                    ...
                    <Select
                      onValueChange={(value) =>
                        setNewEntry({ ...newEntry, stress: parseInt(value) })
                      }
                    >
                      <SelectTrigger>
